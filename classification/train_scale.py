...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Fine-tune ruBERT on scale classification.")
    ...
    parser.add_argument(
        "--out_dir",
        default="models_out/scale",
        help="Directory to store the fine-tuned model and tokenizer (default: models_out/scale).",
    )
    parser.add_argument(
        "--tb_dir",
        default=None,
...
def main() -> None:
    ...
    print("\n=== Scale classification: validation metrics ===")

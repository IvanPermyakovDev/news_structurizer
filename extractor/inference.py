...
def generate_attributes(text, generator):
    # Подготавливаем промпты для всех атрибутов (казахский язык)
    tasks = {
        "title": "тақырып: ",
        "key_events": "оқиға: ",
        "location": "орын: ",
...
def main():
    ...
    # Example text (Kazakh ASR sample)
    new_text_asr = "кайырлы кун курметти корермендер бугин астана каласында халыкаралык форум оз жумысын бастады..."
